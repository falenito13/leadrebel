...
export function createTable() {
    ...
    export function insertTable(name,country,website,categories,address,vat,head_count,sales_staff,sales_turnover,phone_number,description,established_year,export_sales,keywordsArray){
        db.serialize(() => {
